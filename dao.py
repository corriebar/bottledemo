...
@author: onomatopeia, edited by corrie
"""
...
class MockDataAccessObject(object):
    def select(self):
        ...
        for i in range(10):
            ...
            post_date = date.fromordinal(random.randint(date(year=2000, month=1, day=1).toordinal(), today))
            title = lorem.sentence()
            post_dict = {'CONTENT': paragraph, 'POST_DATE' : post_date, 'AUTHOR': 'corrie', 'TITLE': title}
